...
public class rentDetails {
		...
		static List<aboutCamera> cameraList = new ArrayList<>();
		static List<userDetail> users = new ArrayList<>();
		static Map<String, Double> wallet = new HashMap<>();
		static String loggedInUser = null;

		public static void main(String[] args) {
			cameraList.add(new aboutCamera(1, "Samsung", "DS123",500.0, "Available"));
			cameraList.add(new aboutCamera(2, "Sony", "HD214", 500.0, "Available"));
			cameraList.add(new aboutCamera(3, "Panasonic", "XC", 500.0, "Available"));
			cameraList.add(new aboutCamera(4, "Canon", "XLR", 500.0, "Available"));
			cameraList.add(new aboutCamera(5, "Fujitsu", "J5", 500.0, "Available"));
			cameraList.add(new aboutCamera(7, "Sony", "HD226", 500.0, "Available"));
			cameraList.add(new aboutCamera(8, "Samsung", "DS246",500.0, "Available"));
			cameraList.add(new aboutCamera(9, "LG", "L123", 500.0, "Available"));
			cameraList.add(new aboutCamera(10, "Canon", "XPL",500.0, "Available"));
			cameraList.add(new aboutCamera(11, "Chroma", "CT", 500.0, "Available"));
			cameraList.add(new aboutCamera(12, "Something", "some", 2000.0, "Available"));
			cameraList.add(new aboutCamera(13, "Some", "Another", 1000.0, "Available"));
			cameraList.add(new aboutCamera(14, "Canon", "Digital", 123.0, "Available"));
			cameraList.add(new aboutCamera(15, "NIKON", "DSLR-D7500", 5000.0, "Available"));
			cameraList.add(new aboutCamera(16, "Sony", "DSLR12", 25000.0, "Available"));
			cameraList.add(new aboutCamera(17, "Samsung", "SM123", 2000.0, "Available"));
			cameraList.add(new aboutCamera(18, "Sony", "SONY1234", 1234.0, "Available"));
			users.add(new userDetail("priyanka", "priya123", 10000));
				...
				if (user.getUsername().equalsIgnoreCase(loggedInUser)) {
					...
					if (input.equals("1")) {
						try {
							...
							userDetail userToUpdateWallet = null;
							for (int j = 0; j < users.size(); j++) {
								userDetail user1 = users.get(j);
								if (user.getUsername().equalsIgnoreCase(loggedInUser)) {
...
//			sc.close();
		...
		private static void rentCamera(String loggedInUser) {
			...
			try {
				...
				aboutCamera getcamera = getCameraById(cameraList, cameraCode);
				if (getcamera == null) {
				...
				for (aboutCamera camera : cameraList) {
...
//			sc.close();
		...
		public static aboutCamera getCameraById(List<aboutCamera> cameraList, int id) {
			for (aboutCamera camera : cameraList) {
				if (camera.getId() == id) {
					return camera;
				}
...
//				System.out.println("\nADD CAMERA");
				...
				aboutCamera camera = new aboutCamera(id, brand, model, price, "Available");
		...
		public static int generateCameraId() {
			...
			if (!cameraList.isEmpty()) {
				aboutCamera lastCamera = cameraList.get(cameraList.size() - 1);
		...
		public static void removeCamera() {
		    ...
		    try {
		        ...
		        for (int i = 0; i < cameraList.size(); i++) {
		        	aboutCamera camera = cameraList.get(i);
