...
public class userDetail {
		 ...
		 private String username;
		    ...
		    private ArrayList<aboutCamera> myCameras;
		    private double wallet;

		    public userDetail(String username, String password, double wallet) {
		    ...
		    public userDetail(String username, String password, ArrayList<aboutCamera> myCameras, double wallet) {
				super();
				this.username = username;
				this.password = password;
		        myCameras = new ArrayList<>();
...
//		    }
		    ...
		    public ArrayList<aboutCamera> getMyCameras() {
		        return myCameras;
		    }

		    public void addCamera(aboutCamera camera) {
		        myCameras.add(camera);
		    }
		    
		    public void setMyCameras(ArrayList<aboutCamera> myCameras) {
		        this.myCameras = myCameras;
		    }

		    public void removeCamera(int id) {
		        for (aboutCamera camera : myCameras) {
		            if (camera.getId() == id) {
		    ...
		    public void rentCamera(aboutCamera camera, int days) {
